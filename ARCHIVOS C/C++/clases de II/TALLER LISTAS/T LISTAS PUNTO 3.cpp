...
void menu()
{
	cout<<"\t\t\tTALLER DE LISTAS PUNTO 3"<<endl;
	cout<<"1. PARA LLENAR LA LISTA"<<endl;
	cout<<"2. PARA CONSULTAR (MOSTRAR) LA LISTA"<<endl;
	cout<<"3. PARA MULTIPLICAR LOS ELEMENTOS DE LA LISTA ENTRE SI"<<endl;
...
//___________________________________________________________________________________________________________________________________________
void multiplicar_lista()
{
	cout<<"\t\tMULTIPLICANDO ELEMENTOS DE LA LISTA"<<endl;
	Nodo *corredor = new Nodo();
	int n=1;
	corredor = lista;
	if(corredor != NULL)
	{
		...
		cout<<"LA MULTIPLICACIÓN DE LOS ELEMENTOS DE LA LISTA ES: "<<n<<endl;
	}
	else
	{
		cout<<"\t\tLA LISTA ESTA VACIA"<<endl;
