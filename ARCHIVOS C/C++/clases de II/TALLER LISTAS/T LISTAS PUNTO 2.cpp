...
Nodo *lista=NULL;
int op, num, cant_nodos=0;
void menu()
{
	cout<<"\t\t\tTALLER DE LISTAS PUNTO 2"<<endl;
	cout<<"1. PARA LLENAR LA LISTA"<<endl;
	cout<<"2. PARA CONSULTAR (MOSTRAR) LA LISTA"<<endl;
	cout<<"3. PARA SABER EL NUMERO DE NODOS QUE POSEE LA LISTA"<<endl;
	...
	do
	{
		...
		switch(op)
		{
			...
			case 2: system("cls");
					...
					break;
			case 3: system("cls");
					cout<<"EL NÚMERO DE NODOS QUE POSEE LA LISTA ES: "<<cant_nodos<<endl;
					system("pause");
					system("cls");
					break;		
			case 4: system("cls");
