...
void menu()
{
	cout<<"\t\t\tTALLER DE LISTAS PUNTO 5"<<endl;
	cout<<"1. PARA LLENAR LA LISTA"<<endl;
	cout<<"2. PARA CONSULTAR (MOSTRAR) LA LISTA"<<endl;
	cout<<"3. PARA BUSCAR UN ELEMENTO EN LA LISTA"<<endl;
...
void buscar_lista()
{
	cout<<"\t\tBUSCANDO ELEMENTOS EN LA LISTA"<<endl;
	Nodo *corredor = new Nodo();
	corredor = lista;
	char band = 'f';
	int pos = 1, buscado;
	...
	if(lista != NULL)
	{
		...
		cout<<"DIGITE AQUI: ";	cin>>buscado;
		while((corredor!=NULL) && (band == 'f'))
		{
			if(corredor->dato == buscado)
			{
				cout<<"EL ELEMENTO FUE ENCONTRADO EN LA LISTA EN LA POSICIÓN "<<pos<<endl;
				band = 'v';
			}
			else
			{
